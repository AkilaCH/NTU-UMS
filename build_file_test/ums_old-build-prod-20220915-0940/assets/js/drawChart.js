    ...
    function update(source) {
        ...
        function drawNodes(node, cx) {
            ...
            nodeEnter.append("text")
                .attr("id", "value")
                .attr("x", function (d) {
                    // console.log(Math.max(getWidthOfText(lineBreaker(d.name, characterLength)[0], "16px"), getWidthOfText(lineBreaker(d.name, characterLength)[0], "16px")));
                    return 100+60;
